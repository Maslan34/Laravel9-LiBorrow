            ...
            <div class="card">
                ...
                <div class="card-body">
                    <a href="/admin/category/edit/{{$data->id}}">
                        <button  style="margin-bottom:25px " type="button" class="btn btn-gradient-warning btn-rounded btn-fw">Edit</button>
                    </a>

                    <a href="/admin/category/destroy/{{$data->id}}">
                        <button style="margin-bottom:25px "  onclick="confirm('Are You Sure?')" type="button" class="btn btn-gradient-warning btn-rounded btn-fw">Delete</button>
                    </a>
                    ...
                    <table class="table table-bordered">
                        ...
                        <tr class="table-info">
                            ...
                            <td> {{Illuminate\Support\Facades\Storage::url($data->image)}}}} </td>
                        </tr>
