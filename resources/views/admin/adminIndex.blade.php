                ...
                <div class="row">
                    <div class="col-md-4 stretch-card grid-margin">
                        <div class="card bg-gradient-danger card-img-holder text-white">
                            <div class="card-body">
                                <img src="{{asset('assetsForAdmin')}}/images/dashboard/circle.svg" class="card-img-absolute" alt="circle-image" />
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tr>
                                            <td>
                                                <img src="{{asset('assetsForAdmin')}}/images/faces/face1.jpg" class="me-2" alt="image"> David Grey
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <img src="{{asset('assetsForAdmin')}}/images/faces/face2.jpg" class="me-2" alt="image"> Stella Johnson
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <img src="{{asset('assetsForAdmin')}}/images/faces/face3.jpg" class="me-2" alt="image"> Marina Michel
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <img src="{{asset('assetsForAdmin')}}/images/faces/face4.jpg" class="me-2" alt="image"> John Doe
                                            </td>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row mt-3">
                                    <div class="col-6 pe-1">
                                        <img src="{{asset('assetsForAdmin')}}/images/dashboard/img_1.jpg" class="mb-2 mw-100 w-100 rounded" alt="image">
                                        <img src="{{asset('assetsForAdmin')}}/images/dashboard/img_4.jpg" class="mw-100 w-100 rounded" alt="image">
                                    </div>
                                    <div class="col-6 ps-1">
                                        <img src="{{asset('assetsForAdmin')}}/images/dashboard/img_2.jpg" class="mb-2 mw-100 w-100 rounded" alt="image">
                                        <img src="{{asset('assetsForAdmin')}}/images/dashboard/img_3.jpg" class="mw-100 w-100 rounded" alt="image">
                                    </div>
                                </div>
                                <div class="d-flex mt-5 align-items-top">
                                    <img src="{{asset('assetsForAdmin')}}/images/faces/face3.jpg" class="img-sm rounded-circle me-3" alt="image">
